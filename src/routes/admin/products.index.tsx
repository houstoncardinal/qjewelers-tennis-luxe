        ...
        <PageTransition>
          ...
          <div className="mb-4 sm:mb-6 flex items-start justify-between gap-3 flex-wrap">
            ...
            <div className="flex items-center gap-2 flex-wrap shrink-0">
              <button
                onClick={() => { triggerHaptic('light'); doExport(); }}
                className="inline-flex items-center gap-1.5 border border-gray-200 text-gray-600 px-2.5 py-2 text-[0.60rem] uppercase tracking-[0.10em] hover:border-gray-400 hover:text-gray-900 transition-colors active:scale-95"
              ...
              <button
                onClick={() => { triggerHaptic('warning'); setShowDeleteAll(true); }}
                className="inline-flex items-center gap-1.5 border border-red-200 text-red-500 px-2.5 py-2 text-[0.60rem] uppercase tracking-[0.10em] hover:border-red-400 hover:bg-red-50 transition-colors active:scale-95"
              >
                <Trash2 className="h-3.5 w-3.5" />
                <span className="hidden sm:inline">Delete All</span>
              </button>
              <button
                onClick={() => { triggerHaptic('light'); setShowImport(true); }}
                className="inline-flex items-center gap-1.5 border border-gray-200 text-gray-600 px-2.5 py-2 text-[0.60rem] uppercase tracking-[0.10em] hover:border-gray-400 hover:text-gray-900 transition-colors active:scale-95"
              >
